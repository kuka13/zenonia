local gates = {
	[9710] = {value = 1, position = Position(33290, 31786, 13)},
	[9711] = {value = 2, position = Position(33290, 31786, 13)},
	[9712] = {value = 3, position = Position(33290, 31786, 13)},
	[9713] = {value = 4, position = Position(33290, 31786, 13)},
	[9714] = {value = 5, position = Position(33290, 31786, 13)},
	[9716] = {value = 6, position = Position(33290, 31786, 13)}
}
