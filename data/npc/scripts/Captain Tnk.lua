...
local voices = { {text = 'Passages to new continente Mordus, Emperia and Eva.'} }
...
addTravelKeyword('mordus', 100, Position(31072, 31405, 6))
addTravelKeyword('eva', 100, Position(31072, 31405, 6))
addTravelKeyword('emperia', 100, Position(31363, 31330, 7))
...
keywordHandler:addKeyword({'trip'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Mordus}, {Eva} or {Emperia}?'})
keywordHandler:addKeyword({'route'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Mordus}, {Eva} or {Emperia}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Mordus}, {Eva} or {Emperia}?'})
keywordHandler:addKeyword({'town'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Mordus}, {Eva} or {Emperia}?'})
keywordHandler:addKeyword({'destination'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Mordus}, {Eva} or {Emperia}?'})
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Mordus}, {Eva} or {Emperia}?'})
keywordHandler:addKeyword({'go'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Mordus}, {Eva} or {Emperia}?'})
