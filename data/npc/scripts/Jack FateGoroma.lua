...
local voices = { {text = 'Passages to Liberty Bay.'} }
...
addTravelKeyword('liberty bay', 0, Position(32285,32891, 6))
...
-- Basic
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Liberty Bay}?'})
