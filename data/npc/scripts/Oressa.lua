...
local oressaKeyword = keywordHandler:addKeyword({'vocation'}, StdModule.say, {npcHandler = npcHandler, text = 'There are four vocations in Tibia: Knight, Sorcerer, Paladin or Druid. Each one has its unique special abilities. ... Think carefully, as you can\'t change your vocation later on! You will have to {choose} your {vocation} in order to leave Dawnport for the main continent through one of these doors behind me. ... Talk to me again when you are ready to choose your vocation, and I will set you on your way.'})
	oressaKeyword:addChildKeyword({'vocation'}, StdModule.say, {npcHandler = npcHandler, text = 'You have choose your vocation, now leave Dawnport for the main continent through one of these doors behind me.', reset = true},
	...
	oressaKeyword:addChildKeyword({'vocation'}, StdModule.say, {npcHandler = npcHandler, text = 'Sorry, your level is lower than 8 or you already choose your vocation.', reset = true})
	...
	oressaKeyword:addChildKeyword({''}, StdModule.say, {npcHandler = npcHandler, text = 'Well, then don\'t.', reset = true})
	
	local oressa2Keyword = keywordHandler:addKeyword({'choose'}, StdModule.say, {npcHandler = npcHandler, text = 'There are four vocations in Tibia: Knight, Sorcerer, Paladin or Druid. Each one has its unique special abilities. ... Think carefully, as you can\'t change your vocation later on! You will have to {choose} your {vocation} in order to leave Dawnport for the main continent through one of these doors behind me. ... Talk to me again when you are ready to choose your vocation, and I will set you on your way.'})
	oressa2Keyword:addChildKeyword({'vocation'}, StdModule.say, {npcHandler = npcHandler, text = 'You have choose your vocation, now leave Dawnport for the main continent through one of these doors behind me.', reset = true},
		function(player) return player:getStorageValue(Storage.Dawnport.Oressa) < 1 end,
		function(player)
			player:setStorageValue(Storage.Dawnport.Oressa, 1)
		end
	)
	oressa2Keyword:addChildKeyword({'choose'}, StdModule.say, {npcHandler = npcHandler, text = 'You have choose your vocation, now leave Dawnport for the main continent through one of these doors behind me.', reset = true},
		function(player) return player:getStorageValue(Storage.Dawnport.Oressa) < 1 end,
		function(player)
			player:setStorageValue(Storage.Dawnport.Oressa, 1)
	...
	oressa2Keyword:addChildKeyword({'vocation'}, StdModule.say, {npcHandler = npcHandler, text = 'Sorry, your level is lower than 8 or you already choose your vocation.', reset = true})
	oressa2Keyword:addChildKeyword({'choose'}, StdModule.say, {npcHandler = npcHandler, text = 'Sorry, your level is lower than 8 or you already choose your vocation.', reset = true})
	oressa2Keyword:addChildKeyword({''}, StdModule.say, {npcHandler = npcHandler, text = 'Well, then don\'t.', reset = true})
