...
addTravelKeyword('venore', 100, Position(32954, 32022, 6)) -- {x = 32954, y = 32022, z = 6}
addTravelKeyword('edron', 100, Position(33176, 31765, 6)) -- {x = 33176, y = 31765, z = 6}
addTravelKeyword('oramond', 100, Position(33479, 31985, 7)) -- {x = 33479, y = 31985, z = 7}
addTravelKeyword('darashia', 100, Position(33289, 32481, 6)) -- {x = 33289, y = 32481, z = 6}
...
local travelNode = keywordHandler:addKeyword({'darashia'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you seek a passage to Darashia for |TRAVELCOST|?', cost = 0, discount = 'postman'})
	local childTravelNode = travelNode:addChildKeyword({'yes'}, StdModule.say, {npcHandler = npcHandler, text = 'I warn you! This route is haunted by a ghostship. Do you really want to go there?'})
		childTravelNode:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = true, cost = 100, discount = 'postman', destination = function(player) return math.random(10) == 1 and Position(33324, 32173, 6) or Position(33289, 32481, 6) end})
...
-- Basic
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Edron}, {Issavi}, {Darashia}, {Oramond} or {Venore}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Edron}, {Issavi}, {Darashia}, {Oramond} or {Venore}?'})
