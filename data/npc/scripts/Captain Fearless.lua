...
addTravelKeyword('thais', 100, Position(32310, 32210, 6))
addTravelKeyword('krailos', 100, Position(33493, 31712, 6)) -- {x = 33493, y = 31712, z = 6}
addTravelKeyword('carlin', 100, Position(32387, 31820, 6))
addTravelKeyword('gray island', 100, Position(33196, 31984, 7))
addTravelKeyword('ab\'dendriel', 100, Position(32734, 31668, 6))
addTravelKeyword('edron', 100, Position(33173, 31764, 6))
addTravelKeyword('port hope', 100, Position(32527, 32784, 6))
addTravelKeyword('svargrond', 100, Position(32341, 31108, 6))
addTravelKeyword('liberty bay', 100, Position(32285, 32892, 6))
addTravelKeyword('yalahar', 100, Position(32816, 31272, 6))
addTravelKeyword('ankrahmun', 100, Position(33092, 32883, 6))
addTravelKeyword('issavi', 100, Position(33901, 31464, 6))
...
-- Basic
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {krailos}, {Thais}, {Carlin}, {Ab\'Dendriel}, {Port Hope}, {Edron}, {Darashia}, {Issavi}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Gray Island} or {Ankrahmun}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {krailos}, {Thais}, {Carlin}, {Ab\'Dendriel}, {Port Hope}, {Edron}, {Darashia}, {Issavi}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Gray Island} or {Ankrahmun}?'})
