...
addTravelKeyword('anti entrosa', 0, Position(31040, 32795, 7))
...
npcHandler:setMessage(MESSAGE_GREET, 'Bem vindo |PLAYERNAME|. estou aqui para te levar para uma Area Privada de War, Qual {anti entrosa} ou voltar {exit}??')
