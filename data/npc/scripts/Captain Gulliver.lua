...
addTravelKeyword('thais', 100, Position(32311, 32210, 6))
addTravelKeyword('krailos', 100, Position(33493, 31712, 6))
addTravelKeyword('issavi', 100, Position(33915, 31446, 6))
...
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'You would like to book a passage for {Thais}, {Issavi} or {Krailos}?'})
keywordHandler:addKeyword({'route'}, StdModule.say, {npcHandler = npcHandler, text = 'You would like to book a passage for {Thais}, {Issavi} or {Krailos}?'})
keywordHandler:addKeyword({'trip'}, StdModule.say, {npcHandler = npcHandler, text = 'You would like to book a passage for {Thais}, {Issavi} or {Krailos}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'You would like to book a passage for {Thais}, {Issavi} or {Krailos}?'})
keywordHandler:addKeyword({'town'}, StdModule.say, {npcHandler = npcHandler, text = 'You would like to book a passage for {Thais}, {Issavi} or {Krailos}?'})
keywordHandler:addKeyword({'destination'}, StdModule.say, {npcHandler = npcHandler, text = 'You would like to book a passage for {Thais}, {Issavi} or {Krailos}?'})
keywordHandler:addKeyword({'go'}, StdModule.say, {npcHandler = npcHandler, text = 'You would like to book a passage for {Thais}, {Issavi} or {Krailos}?'})
