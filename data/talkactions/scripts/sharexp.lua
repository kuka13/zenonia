function onSay(player, words, param)
	...
	if not party then
	player:sendTextMessage(MESSAGE_EVENT_ADVANCE, 'Seu nivel eh '.. player:getLevel() ..'. Voce pode sharear com players de level '.. math.floor(player:getLevel()*0.67) ..' ate level '.. math.floor(player:getLevel()*1.67) ..'.')
	return false
	end
