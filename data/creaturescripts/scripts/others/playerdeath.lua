...
if player:getStorageValue(STORAGE_PLAYER_IN_ARENA) == 1 then
    ...
    if corpse then
        local reward = corpse:addItem(33272, 1)
		reward:setAttribute(ITEM_ATTRIBUTE_DESCRIPTION, "You see a skull of " .. player:getName() .. " that was killed at level " .. player:getLevel() .. " by " .. killer:getName() .. " who was level " .. killer:getLevel() .. ". ")
		reward:setAttribute(ITEM_ATTRIBUTE_NAME, "Skull of " .. player:getName() .. "")
    end
