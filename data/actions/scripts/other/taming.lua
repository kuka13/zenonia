...
local config = {
	[23810]	=	{NAME = 'Noble Lion',					ID = 40,		TYPE = TYPE_MONSTER,	CHANCE = 50,	FAIL_MSG = { {1, 'The Noble Lion ran away.'}, {2, 'Oh no! The Lion Heart.'}, {3, 'The Noble Lion is trying to hit you with its claws.'} },SUCCESS_MSG = 'You have tamed the Noble Lion.'},
	...
	[13298]	=	{NAME = 'Terror Bird',				ID = 2,		TYPE = TYPE_MONSTER,	CHANCE = 40,	FAIL_MSG = { {1, 'The bird ran away.'}, {3, 'The terror bird is pecking you.'} }, SUCCESS_MSG = 'You have tamed the bird.'},
	...
	[13291]	=	{NAME = 'Undead Cavebear',			ID = 12,	TYPE = TYPE_MONSTER,	CHANCE = 30,	FAIL_MSG = { {1, 'The undead bear has run away.'} }, SUCCESS_MSG = 'You have tamed the skeleton.'},
	...
	[13294]	=	{NAME = 'Draptor',				ID = 6,		TYPE = TYPE_MONSTER,	CHANCE = 30,	FAIL_MSG = { {1, 'The draptor has run away.'}, {3, 'The draptor has fled.'} }, SUCCESS_MSG = 'You have tamed the draptor.'},
	[13536]	=	{NAME = 'Crystal Wolf',				ID = 16,	TYPE = TYPE_MONSTER,	CHANCE = 30,	FAIL_MSG = { {1, 'The wolf has run away.'} }, SUCCESS_MSG = 'You have tamed the wolf.'},
	...
	[32491]	=	{NAME = 'Flying Book',				ID = 126,	TYPE = TYPE_MONSTER,	CHANCE = 10,	FAIL_MSG = { {1, 'Flying Book has run away.'} }, SUCCESS_MSG = 'You have tamed the Flying Book.'},
	...
	[30840]	=	{NAME = 'Mole',				ID = 119,	TYPE = TYPE_MONSTER,	CHANCE = 25,	FAIL_MSG = { {1, 'Mole has run away.'} }, SUCCESS_MSG = 'You have tamed the Mole.'},
	...
	[13498]	=	{NAME = 'Sandstone Scorpion',			ID = 21,	TYPE = TYPE_MONSTER,	CHANCE = 20,	FAIL_MSG = { {1, 'The scorpion has vanished.'}, {2, 'Scorpion broken the sceptre.'} }, SUCCESS_MSG = 'You have tamed the scorpion.'},
	...
	[15546]	=	{NAME = 'Ladybug',				ID = 27,	TYPE = TYPE_MONSTER,	CHANCE = 20,	FAIL_MSG = { {1, 'The ladybug got scared and ran away.'}, {3, 'The ladybug is trying to nibble.'} }, SUCCESS_MSG = 'You tame a lady bug.'},
    ...
    [34809]	=	{NAME = 'Hibernal Moth', 				ID = 131,	TYPE = TYPE_MONSTER,	CHANCE = 30,	FAIL_MSG = { {2, 'The Hibernal Moth got scared and ran away.'}, {4, 'The Hibernal Moth is trying to nibble.'} }, SUCCESS_MSG = 'You tamed the Hibernal Moth.'},
	[34808]	=	{NAME = 'Lacewing Moth', 				ID = 130,	TYPE = TYPE_MONSTER,	CHANCE = 30,	FAIL_MSG = { {2, 'The Lacewing Moth got scared and ran away.'}, {4, 'The Lacewing Moth is trying to nibble.'} }, SUCCESS_MSG = 'You tamed the Lacewing Moth.'},
	[27628]	=	{NAME = 'Stone Rhino', 				ID = 106,	TYPE = TYPE_MONSTER,	CHANCE = 30,	FAIL_MSG = { {2, 'The Stone Rhino got scared and ran away.'}, {4, 'The Stone Rhino is trying to nibble.'} }, SUCCESS_MSG = 'You tamed the Stone Rhino.'},
