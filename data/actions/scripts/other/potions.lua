local config = {
	...
	[26031] = {health = {min = 950, max = 1000}, vocations = {4}, text = 'knights', level = 200, emptyId = 7635},
	
	-- Ultimate Spirit Potion 26030
	[26030] = {health = {min = 650, max = 700}, mana = {min = 140, max = 250}, vocations = {3}, text = 'paladins', level = 130, emptyId = 7635},
...
if (player:getStorageValue(STORAGE_PLAYER_IN_ARENA) == 1 and player:getStorageValue(STORAGE_POTION) == 1) then
	...
	local flask = player:getStorageValue(250122)
