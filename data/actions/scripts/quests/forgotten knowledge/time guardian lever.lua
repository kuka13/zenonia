local config = {
	requiredLevel = 200,
	daily = true,
	BossPosition = Position(32977, 31660, 14),
	MinosPosition = Position(32977, 31659, 14),
	centerDemonRoomPosition = Position(32977, 31663, 14),
	playerPositions = {
		Position(33010, 31660, 14), -- Posição dos players 1,2,3,4,5
...
function onUse(player, item, fromPosition, target, toPosition, monster, isHotkey)
	if item.itemid == 9825 then
		...
		for i = 1, #config.playerPositions do
			...
			if not (player:getStorageValue(48002) <= os.time()) then
		...
		local players
		local monster = Game.createMonster("the time guardian", Position(32977, 31660, 14))
		monster:setReward(true)
		for i = 1, #storePlayers do
			players = storePlayers[i]
		
			if not (players:getStorageValue(48002) <= os.time()) then
		...
		for i = 1, #storePlayers do
			...
			player:setStorageValue(48002, os.time()+exaustedSeconds*72000)
		end
