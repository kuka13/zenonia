local config = {
	requiredLevel = 250,
	daily = true,
	BossPosition = Position(31558, 31952, 11),
	MinosPosition = Position(31558, 31950, 11),
	centerDemonRoomPosition = Position(31558, 31951, 11),
	playerPositions = {
		Position(31516, 31929, 11), -- Posição dos players 1,2,3,4,5
		Position(31517, 31929, 11),
		Position(31518, 31929, 11),
		Position(31519, 31929, 11),
		Position(31520, 31929, 11)

	},
	newPositions = {
		Position(31556, 31959, 11),
		Position(31557, 31959, 11),
		Position(31558, 31959, 11),
		Position(31559, 31959, 11),
		Position(31560, 31959, 11)
	},
}
...
function onUse(player, item, fromPosition, target, toPosition, monster, isHotkey)
	if item.itemid == 32586 then
	    if player:getPosition() ~= Position(31516, 31929, 11) then
		...
		for i = 1, #config.playerPositions do
			...
			if not (player:getStorageValue(460021) <= os.time()) then
		...
		local players
		local monster = Game.createMonster("Lokathmor", Position(31558, 31952, 11))
		monster:setReward(true)
		for i = 1, #storePlayers do
			players = storePlayers[i]
		
			if not (players:getStorageValue(460021) <= os.time()) then
		...
		for i = 1, #storePlayers do
			...
			player:setStorageValue(460021, os.time()+exaustedSeconds*10800)
		end
